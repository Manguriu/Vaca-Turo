...
export default function DateComponent({
  ...
  return (
    <div className="py-6 w-full  px-3 spacing-5 max-md:w-auto h-full bg-white shadow-sm rounded pt-6 pb-8 mb-4">
      <div className="w-full gap-2">
        <div className="flex justify-between flex-col">
          ...
          <div className="flex justify-between">
            <h1 className="font-extrabold text-[16px]">{name}</h1>
            <h1 className="font-extrabold text-[16px]">{price}</h1>
          </div>
        </div>
