        ...
        <div className="px-4 py-4">
          ...
          <div>
            <p>
              ...
              van with balanced combination of economy, luxury and performance.
              The vans pleasing interior, relaxed cabin, space, safety features
              makes it an attractive solution to many of todays traffic and
              environmental problems. Quick acceleration, excellent handling and
              a
            </p>
          </div>
        ...
        <div className="px-4 py-4 w-[30%]">
          ...
          <div className="mt-5">
            <div className="mb-4 mt-4 max-lg:hidden">
              <h4 className="max-lg:text-2xl text-xl text-cyan-400 max-lg:w-fit">
                Trip start & Trip end{" "}
              </h4>
            </div>
